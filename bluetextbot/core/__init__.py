...
from bluetextbot.core.loader import ModuleLoader
from bluetextbot.core.task_manager import (BaseCoreTask, BaseSchedulerTask,
                                           TaskManager)
...
class BotCore:
    ...
    async def _startup(self, dispatcher: Dispatcher):
        ...
        if self.config.get_item("features", "use_modern_callback"):
            from bluetextbot.keyboards.middlewares import \
